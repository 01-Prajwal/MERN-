...
const Profile = () => {
  ...
  return (
    <div className='p-3 max-w-lg mx-auto'>
      ...
      <form onSubmit={handleSubmit} action="" className='flex flex-col gap-14'>
      <input type="file"  ref={fileRef}   onChange={(e) => setFile(e.target.files[0])} hidden accept='image/*' />
        ...
        <input type="text" onChange={handleChange} id='username' placeholder='username' defaultValue={currentUser.username} className='border p-3 rounded-lg'/>
